...
async function resetPassword(owner) {
    ...
    html.push('<p>I have activated your account on cactusfantasy.com. Your username is: <b>jcurrigan</b></p>');
    html.push(`<p>You need to set a password.Follow this <a href="http://cactusfantasy.com/password-reset/${key}" target="_blank">Password Reset Link</a> to reset your password.</p>`);
    ...
    html.push('<p>Thank you,</p><p>CFL Admin Team (i.e. Josh)</p>');
    const msgInfo = {
        ...
        subject: "Account Setup", // Subject line
        html: html.join("")
    };
